...
public class Main {
    ...
    public static void main(String... args) {
        ...
        System.out.printf("Media dos tempos de atendimento (%.0f simulacoes): %.3fmin%n", (double) NUMERO_SIMULACOES, media);
        System.out.printf("Desvio-padrao das medias: %.3f min%n", dp);
    }
